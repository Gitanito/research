...
$(document).ready(function(){
    ...
    $(document).on("mouseup", function(){
        ...
        if (t == "fav") {
            if (confirm('Wollen Sie "' +window.getSelection().toString() + '" zu einem Haupt-Thema machen?')) {
                makeGPT("Schreibe mir eine Zusammenfassung des Buches:");
            }
        }
        if (t == "link") {
